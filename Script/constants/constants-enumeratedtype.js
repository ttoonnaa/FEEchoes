...
var SceneType = {
	// 以下のシーンでは、バトル系のイベントコマンドを使用できない
	TITLE: 0,
	GAMEOVER: 1,
	ENDING: 2,

	// 以下のシーンでは、バトル系のイベントコマンドを使用できる
	BATTLESETUP: 3,
	FREE: 4,
	BATTLERESULT: 5,
	REST: 6,
	...
	// 使用できるイベントコマンドは、呼び出し元のシーンに依存する
	EVENT: 10,
	
	// 20以上50000未満は、カスタムシーンとして使用してよい
	CUSTOM: 20,
...
var BattleType = {
	REAL: 0,
	EASY: 1,
	// 以下の値の場合でも、最終的にはREALかEASYとして扱われる
	DEFAULT: 2,
	FORCEREAL: 3,
	FORCEEASY: 4
};
...
// EASYATTACKは、簡易攻撃をする時に必ず表示される。
// EASYDAMAGEは、簡易攻撃が命中した時に表示される。
...
var AppScreenMode = {
	...
	// root.getAppScreenModeの戻り値
	HARDFULLSCREEN: 1,
	SOFTFULLSCREEN: 2,
	
	// root.setAppScreenModeの引数
	FULLSCREEN: 3
};
