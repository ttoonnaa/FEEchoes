...
var TrophyCollector = defineObject(BaseObject,
{
	...
	_addDrop: function(trophy) {
		...
		// falseを指定することで、その場でゴールド/ボーナスを増減させない
	...
	_compareTrophy: function(data, trophy) {
		var isGold = false;
		var isBonus = false;
		var isItem = false;
