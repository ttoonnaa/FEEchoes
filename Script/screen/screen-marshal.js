...
var MarshalScreen = defineObject(BaseScreen,
{
	...
	getUnitList: function() {
		// this._unitListを返すと、ユニットの並び替えが発生した場合に対応できない
	...
	_selectMarshalCommand: function() {
		var object;
...
MarshalCommand.ItemUse = defineObject(MarshalBaseCommand,
{
	...
	notifyScreenClosed: function() {
		...
		// もし、蘇生アイテムが使用されたならば、リストにユニットが復帰するため、
		// リストを再構築するべきといえる。
		this._parentMarshalScreen.updateUnitList();
		
		// リストを再構築した時に、スクロール位置が初期化されないようにする
