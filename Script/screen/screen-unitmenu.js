...
var UnitMenuScreen = defineObject(BaseScreen,
{
	...
	drawScreenCycle: function() {
		...
		// this._pageChanger.drawPageをthis._topWindow.drawWindowの後に呼び出さない。
		// そのようにすると、スクロールカーソルがアイテムウインドウの上に表示されてしまう。
		// _setMenuDataでは、setDrawingMethodを呼び出すことで、カーソルが先に描画されるようにしている。
	},
	...
	_moveTopMode: function() {
		...
		// 上下のキーが押された場合は_changeTargetでユニットが切り替わる
